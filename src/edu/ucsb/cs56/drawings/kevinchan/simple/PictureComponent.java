package edu.ucsb.cs56.drawings.kevinchan.simple;
...
/**
   ...
   @author Kevin Chan (fixed the snowmans's head)
   @version for UCSB CS56, Summer 16
*/
...
{  
    ...
    {  
        ...
        Circle snowManTopCircle = new Circle(snowManCenterBottomX,snowManCenterBottomY - 
        8*topRadius,topRadius);
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("This is my snowman and house, by Kevin Chan", 20,20);
